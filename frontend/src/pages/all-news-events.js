  ...
  const newsEvents = [
    {
      ...
      export default function AllNewsEvents() {
        ...
        const years = ["all", ...new Set(normalizedNewsEvents.map((item) => new Date(item.date).getFullYear()).filter((year) => !Number.isNaN(year)).sort((a, b) => b - a))];
          ...
          <div className="min-h-screen bg-gray-50">
            ...
            <section className="max-w-6xl mx-auto px-4 py-10">
              <div className="grid md:grid-cols-4 gap-4 mb-8">
                <input className="md:col-span-2 w-full px-4 py-3 border rounded-lg" placeholder="Search news and events..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} />

...
export const defaultPublicSettings = {
  ...
  campusesPage: {
    heroTitle: "Our Campus",
    heroSubtitle: "Premier Engineering Institute in Kolkata - NBA & NAAC Accredited",
  },
  clubsPage: {
    heroTitle: "Clubs & Societies",
    heroSubtitle: "Discover student-led clubs, sports, culture, and leadership opportunities",
  },
  innovationEntrepreneurshipPage: {
    heroTitle: "Innovation & Entrepreneurship at BBIT",
    heroSubtitle: "Empowering creative minds to transform ideas into viable business opportunities",
  },
  exploreResearchPage: {},
  joinOurTeamPage: {},
  internationalPage: {},
  ...
  howToApplyPage: {},
  registerPage: {
    heroTitle: "Student Registration Portal",
    heroSubtitle: "Start your journey with BBIT - register for admissions, placements, events, and research",
    sectionTitle: "Select Registration Type",
  ...
  loginPage: {
    heroTitle: "BBIT R&D Cell",
    heroSubtitle: "User Login (Students & Faculty)",
  ...
  verifyEmailPage: {
    pageTitle: "Verify Email - BBIT R&D Cell",
